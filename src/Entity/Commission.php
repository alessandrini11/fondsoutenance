...
class Commission
{
    ...
    #[ORM\ManyToOne(inversedBy: 'updatedCommissions')]
    private ?User $updatedBy = null;

    #[ORM\OneToMany(mappedBy: 'commission', targetEntity: Membre::class, cascade: ['persist', 'remove'])]
